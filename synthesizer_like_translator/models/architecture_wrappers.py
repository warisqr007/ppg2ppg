...
from synthesizer_like_translator.models.attention import _compute_attention
...
class TacotronDecoderCell(RNNCell):
    ...
    * : This is typically taking a vanilla LSTM, wrapping it using tensorflow"s attention wrapper,
    ...
    def _batch_size_checks(self, batch_size, error_message):
        # print(batch_size)
        # print(self._attention_mechanism.batch_size)
        # if self._attention_mechanism.batch_size is '?' or batch_size is None:
        #return [check_ops.assert_equal(True,True)]
