...
from synthesizer_like_translator.models.helpers import TacoTestHelper, TacoTrainingHelper
...
class CustomDecoder(Decoder):
	...
	def __init__(self, cell, helper, initial_state, output_layer=None):
		...
		if not isinstance(helper, Sampler):
	...
	def output_size(self):
		...
		return CustomDecoderOutput(
				rnn_output=tf.TensorShape([self._rnn_output_size()]),
				token_output=tf.TensorShape([self._helper.token_output_size]),
