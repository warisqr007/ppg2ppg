from synthesizer_like_translator.hparams import hparams
from synthesizer_like_translator.train import tacotron_train
from utils.argutils import print_args
from synthesizer_like_translator import infolog
import argparse
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument("--warm_start_path", type=str, default=None,
                        help="Set to True if finetuning, need restore to be true too")
...
#python synthesizer_preprocess_embeds.py /mnt/data1/waris/datasets/data/arctic_dataset/all_data/SV2TTS/synthesizer
#python synthesizer_train.py Accetron_train /mnt/data1/waris/datasets/data/arctic_dataset/all_data/SV2TTS/synthesizer --models_dir /mnt/data1/waris/model_outputs/accentron/saved_models_gpu
#python synthesizer_train.py Accetron_train_parallel /mnt/data1/waris/datasets/data/arctic_dataset/all_data_for_ac_vc/SV2TTS/synthesizer --models_dir=/mnt/data1/waris/model_outputs/accentron/parallel