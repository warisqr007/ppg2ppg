...
class EncoderPrenet(nn.Module):
    ...
    def __init__(self, embedding_size, num_hidden):
        ...
        #self.dense1 = Linear(embedding_size, embedding_size)
        #self.dense2 = Linear(embedding_size, embedding_size)
        #self.dense_drop1 = nn.Dropout(p=0.5)
        #self.dense_drop2 = nn.Dropout(p=0.5)
    ...
    def forward(self, input_):
        ...
        #input_ = self.dense_drop1(t.relu(self.dense1(input_)))
        #input_ = self.dense_drop2(t.relu(self.dense2(input_)))
